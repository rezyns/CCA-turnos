    ...
    return(
        <div className="bg-black/50 fixed top-0 left-0 z-20 w-full h-full flex justify-center items-center">
            <div className="bg-white lg:w-1/2 h-max p-6 rounded-md relative text-black">
                ...
                <p className="mb-4">¿Estás seguro que deseas eliminar este {type === 'module' ? 'módulo' : 'servicio'} con ID {itemId}?</p>
                <div className="flex justify-end">
                    ...
                    <button onClick={handleDelete} className="bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-600">Eliminar</button>
                </div>
            </div>
        </div>
    )
